...
//        }
  ...
  Viewer.TEMPLATE = (
    '<div class="viewer-container">' +
      ...
      /*'<div class="viewer-left" style="float:left;width:100px;height:100px;z-index:2017;color:#fff;">left<i class="fa fa-angle-left fa-5x"></i></div>'+
      '<div class="viewer-right" style="float:right;width:100px;height:100px;z-index:2017;color:#fff;"><i class="fa fa-angle-right fa-5x"></i></div>'+*/
